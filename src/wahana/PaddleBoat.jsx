        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 text-center w-full px-6">
          <div className="animate-fade-in-up">
            ...
            <p className="text-slate-100 text-lg md:text-xl lg:text-2xl font-light drop-shadow-lg max-w-2xl mx-auto leading-relaxed">
              Rasakan pengalaman mengayuh perahu dengan tenang di atas permukaan
              air, menikmati suasana yang damai dan pemandangan taman yang indah
              dalam wahana Paddle Boat yang cocok untuk semua usia.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mt-2 mb-6">
                Pengalaman Santai <br />
                di <span className="text-blue-600">Paddle Boat</span>
              </h2>
              <div className="space-y-4 text-slate-600 leading-relaxed text-lg">
                <p>
                  Wahana Paddle Boat di Taman Rekreasi Selecta menawarkan
                  pengalaman
                  <span className="text-slate-800 font-semibold">
                    {" "}
                    menyusuri kolam dengan kayuhan ringan{" "}
                  </span>
                  yang memberikan suasana tenang dan menyegarkan. Dengan desain
                  perahu yang stabil dan aman, wahana ini sangat cocok untuk
                  dinikmati bersama teman maupun keluarga.
                </p>
                <p>
                  Rasakan ketenangan air yang jernih, angin sepoi-sepoi, serta
                  pemandangan taman yang indah di sekitar Anda. Paddle Boat
                  menghadirkan perpaduan antara relaksasi dan keseruan ringan,
                  menjadikannya aktivitas ideal untuk menghabiskan waktu santai
                  di tengah keindahan alam Selecta.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
                ...
                <p className="text-slate-600">Maksimal 2 orang untuk tiap kapal</p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="relative">
            <div className="w-full h-[400px] md:h-[600px] lg:h-[750px] rounded-3xl shadow-2xl overflow-hidden border-4 border-white">
              <iframe
                src="/assets/PaddleBoat/index.htm"
                width="100%"
                height="100%"
