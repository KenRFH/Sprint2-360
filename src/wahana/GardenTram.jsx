          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mt-2 mb-6">
                Jelajah Santai dengan <br />
                <span className="text-blue-600">Garden Tram</span>
              </h2>
              <div className="space-y-4 text-slate-600 leading-relaxed text-lg">
                <p>
                  Garden Tram adalah kereta kecil yang membawa pengunjung
                  berkeliling
                  <span className="text-slate-800 font-semibold">
                    {" "}
                    kebun mini penuh warna{" "}
                  </span>
                  di area Taman Rekreasi Selecta. Dengan jalur yang dirancang
                  lembut dan aman, pengalaman ini memberikan cara yang nyaman
                  untuk menikmati keindahan taman tanpa harus banyak berjalan.
                </p>

                <p>
                  Dari atas Garden Tram, Anda dapat melihat beragam tanaman
                  hias, bunga-bunga cerah, hingga sudut-sudut taman yang tertata
                  rapi. Suasana yang sejuk dan pemandangan alami membuat
                  perjalanan singkat ini menjadi momen yang menyenangkan, cocok
                  untuk keluarga maupun anak-anak.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="relative">
            <div className="w-full h-[400px] md:h-[600px] lg:h-[750px] rounded-3xl shadow-2xl overflow-hidden border-4 border-white">
              <iframe
                src="/assets/GardenTram/index.htm"
                width="100%"
                height="100%"
