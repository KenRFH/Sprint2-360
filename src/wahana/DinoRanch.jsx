        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 text-center w-full px-6">
          <div className="animate-fade-in-up">
            ...
            <p className="text-slate-100 text-lg md:text-xl lg:text-2xl font-light drop-shadow-lg max-w-2xl mx-auto leading-relaxed">
              Rasakan sensasi melayang di udara menikmati pemandangan Selecta
          ...
          <div className="space-y-8">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mt-2 mb-6">
                Pengalaman Tak <br />
                Terlupakan di <span className="text-blue-600">Ketinggian</span>
              </h2>
              <div className="space-y-4 text-slate-600 leading-relaxed text-lg">
                <p>
                  Wahana Bianglala di Taman Rekreasi Selecta menawarkan
                  pengalaman
                  <span className="text-slate-800 font-semibold">
                    {" "}
                    berputar perlahan di ketinggian{" "}
                  </span>
                  yang menghadirkan pemandangan spektakuler dari seluruh area
                  taman. Dirancang dengan standar keamanan modern, wahana ini
                  menjadi pilihan favorit bagi pengunjung yang ingin menikmati
                  panorama Kota Batu dari sudut yang lebih luas. Rasakan momen
                  santai sambil melihat hamparan taman bunga, pepohonan asri,
                  dan keindahan lanskap Selecta dari atas gondola yang nyaman.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
                ...
                <p className="text-slate-600">2-4 orang untuk kapasitas</p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="relative">
            <div className="w-full h-[400px] md:h-[600px] lg:h-[750px] rounded-3xl shadow-2xl overflow-hidden border-4 border-white">
              <iframe
                src="/assets/DinoRanch/index.htm"
                width="100%"
                height="100%"
