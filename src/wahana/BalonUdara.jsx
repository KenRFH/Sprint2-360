          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed text-lg">
                <p>
                  Wahana Balon Udara di Taman Rekreasi Selecta menghadirkan
                  pengalaman
                  <span className="text-slate-800 font-semibold">
                    {" "}
                    melayang di udara{" "}
                  </span>
                  yang tak terlupakan. Dirancang khusus dengan standar keamanan
                  tertinggi, wahana ini menjadi destinasi favorit untuk
                  menikmati keindahan alam Batu dari perspektif yang berbeda.
                </p>
                <p>
                  Nikmati sensasi gentle floating sambil memandangi hamparan
                  taman bunga, pepohonan hijau, dan landscape Selecta yang
                  memesona dari ketinggian.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="relative">
            <div className="w-full h-[400px] md:h-[600px] lg:h-[750px] rounded-3xl shadow-2xl overflow-hidden border-4 border-white">
              <iframe
                src="/assets/BalonUdara/index.htm"
                width="100%"
                height="100%"
