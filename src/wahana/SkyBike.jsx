        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 text-center w-full px-6">
          <div className="animate-fade-in-up">
            ...
            <p className="text-slate-100 text-lg md:text-xl lg:text-2xl font-light drop-shadow-lg max-w-2xl mx-auto leading-relaxed">
              Rasakan pengalaman mengayuh sepeda di jalur rel khusus di atas
              ketinggian, menikmati panorama Taman Rekreasi Selecta dari sudut
              yang lebih luas dan menakjubkan dalam wahana Sky Bike yang aman
              dan seru untuk semua usia.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mt-2 mb-6">
                ...
                dari <span className="text-blue-600">Sky Bike</span>
              </h2>
              <div className="space-y-4 text-slate-600 leading-relaxed text-lg">
                <p>
                  Wahana Sky Bike di Taman Rekreasi Selecta menyuguhkan
                  pengalaman
                  <span className="text-slate-800 font-semibold">
                    {" "}
                    mengayuh sepeda di atas rel khusus yang tinggi{" "}
                  </span>
                  sambil menikmati panorama Selecta dari sudut pandang yang
                  memukau. Dengan desain yang aman dan stabil, wahana ini
                  memberikan sensasi baru melihat keindahan taman dari
                  ketinggian tanpa perlu kecepatan atau adrenalin tinggi.
                </p>
                <p>
                  Rasakan hembusan angin sejuk dan pemandangan hijau yang
                  terhampar luas di sekitar Anda. Sky Bike menghadirkan
                  perpaduan antara aktivitas santai dan visual yang menakjubkan,
                  menjadikannya pilihan ideal bagi keluarga maupun pengunjung
                  yang ingin menikmati momen tenang sekaligus unik di Selecta.
                </p>
              </div>
            </div>
