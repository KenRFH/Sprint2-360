        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 text-center w-full px-6">
          <div className="animate-fade-in-up">
            ...
            <p className="text-slate-100 text-lg md:text-xl lg:text-2xl font-light drop-shadow-lg max-w-2xl mx-auto leading-relaxed">
              Rasakan keseruan melaju di lintasan seru bersama keluarga,
              menikmati momen penuh tawa dan adrenalin dalam wahana Family
              Coaster yang ramah untuk semua usia.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mt-2 mb-6">
                Sensasi Seru <br />
                Bersama <span className="text-blue-600">Family Coaster</span>
              </h2>
              <div className="space-y-4 text-slate-600 leading-relaxed text-lg">
                <p>
                  Wahana Family Coaster di Taman Rekreasi Selecta menghadirkan
                  pengalaman
                  <span className="text-slate-800 font-semibold">
                    {" "}
                    melaju ringan di lintasan berkelok{" "}
                  </span>
                  yang aman dan menyenangkan untuk seluruh anggota keluarga.
                  Dibangun dengan desain ramah anak dan tingkat keamanan tinggi,
                  wahana ini menjadi pilihan favorit untuk menikmati momen seru
                  tanpa rasa takut berlebih.
                </p>
                <p>
                  Rasakan kombinasi antara kecepatan yang pas, tikungan lembut,
                  dan sensasi tawa riang yang tercipta sepanjang perjalanan.
                  Family Coaster menawarkan pengalaman bermain yang menyatukan
                  keseruan dan kenyamanan, menjadikannya wahana ideal untuk
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="relative">
            <div className="w-full h-[400px] md:h-[600px] lg:h-[750px] rounded-3xl shadow-2xl overflow-hidden border-4 border-white">
              <iframe
                src="/assets/FamilyCoaster/index.htm"
                width="100%"
                height="100%"
